    ...
    <div className="">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8 ">
        <h1 className="text-3xl font-bold  py-5">
          {" "}
          At Zynoxbit, we help businesses grow online by delivering high-quality
          websites and boosting visibility with SEO.
        </h1>
        <div className="grid grid-cols-2 grid-rows-2 gap-10">
          <div className="space-y-2">
            ...
            <img
              src="performance.jpg"
              className="h-98 w-full rounded-xl transition-all hover:-translate-y-2"
              alt=""
            />
          </div>
          <div className="space-y-2">
